...
function Contact() {
  return (
    <div className="flex flex-col md:flex-row bg-contact-image bg-no-repeat bg-cover bg-center h-screen md:min-h-screen">
      <NavBar />
      <div class="w-full align-middle h-screen items-center animate-fade-in-up flex justify-center pt-10 md:ml-44">
