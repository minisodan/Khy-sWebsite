...
function About() {
  return (
    <div className="flex flex-col md:flex-row bg-about-image bg-no-repeat bg-cover bg-center md:min-h-screen">
      <NavBar />
      <div className="flex flex-col md:ml-44 md:flex-row w-full animate-fade-in-up justify-center items-start p-6 gap-4">
