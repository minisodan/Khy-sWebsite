...
function About() {
  return (
    <div className="flex flex-row bg-about-image bg-no-repeat bg-cover bg-center">
      <NavBar />
      <div className="flex flex-col w-full md:w-3/4 animate-fade-in-up justify-center items-center p-6 gap-4">
        {/* Image section */}
